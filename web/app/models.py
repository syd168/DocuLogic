...
class AppSettings(Base):
    ...
    model_local_path: Mapped[Optional[str]] = mapped_column(String(1024), nullable=True)  # 模型本地路径
    hf_repo_id: Mapped[str] = mapped_column(String(256), default="Logics-MLLM/Logics-Parsing-v2")  # HuggingFace 仓库 ID
    ms_repo_id: Mapped[str] = mapped_column(String(256), default="Alibaba-DT/Logics-Parsing-v2")  # ModelScope 仓库 ID
